...
function Navbar(){
    return (
        <div>
            <div className='px-8 flex items-center justify-between justify-center bg-primary w-full h-16 '>
                <div className='flex'>
    ...
    ROSE DAY
                        ...
                        <Link to='#' className='hover:text-tertiary group'><li>Feb. 8th {'>'}</li><span className="absolute left-1/2 -translate-x-1/2 mt-2 
                   bg-primary border-2 border-background text-tertiary font-bold text-sm px-2 py-1 rounded 
                   opacity-0 group-hover:opacity-100 
                   transition duration-300 twinkle">
    PROPOSE DAY
                        ...
                        <Link to='#' className='hover:text-tertiary group'><li>Feb. 9th {'>'}</li><span className="absolute left-1/2 -translate-x-1/2 mt-2 
                   bg-primary border-2 border-background text-tertiary font-bold text-sm px-2 py-1 rounded 
                   opacity-0 group-hover:opacity-100 
                   transition duration-300 twinkle">
    CHOCOLATE DAY
  </span></Link>
                        <Link to='#' className='hover:text-tertiary group'><li>Feb. 10th {'>'}</li><span className="absolute left-1/2 -translate-x-1/2 mt-2 
                   bg-primary border-2 border-background text-tertiary font-bold text-sm px-2 py-1 rounded 
                   opacity-0 group-hover:opacity-100 
                   transition duration-300 twinkle">
    TEDDY DAY
